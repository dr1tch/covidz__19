...
<div>
     <div class="card bg-card">
        ...
        <h2 v-else class="alert text-center p-5 text-warning">NO MALADIES ADDED YET!!!!</h2>
            ...
            <div>
                ...
                <div class="card bg-card">
                    <div class="card-header">
                        <h4 class="font-weight-bold">Add Maladie</h4>
                    </div>
        ...
        <modal
            ...
            >
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bold">Edit Maladie</h4>
                    </div>
        ...
        <!-- Delete Tag Modal -->
         <modal
            ...
            >
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bold">Delete Maladie</h4>
                    </div>
         ...
         <modal
            ...
            >
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bold">Delete All Maladies</h4>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCategories() {
                this.callAPI('get', '/admin/diseases/get')
                            .then(responce => this.categories = responce);
            },
            addCategory() {
            this.form.post('/admin/diseases/create')
                .then(() => this.$modal.hide('add-category-modal'))
                .then(() => this.getCategories());
            },
             editCategory() {
                 console.log(this.editable.id);
                this.form.post(`/admin/diseases/${this.editable.id}/update`)
                    .then(() => this.$modal.hide('edit-category-modal'))
                    .then(() => this.getCategories());
             },
             deleteCategory() {
                 this.form.post(`/admin/diseases/${this.editable.id}/delete`)
                    .then(() => this.$modal.hide('delete-category-modal'))
                    .then(() => this.getCategories());
             },
             deleteAllCategories() {
                 this.form.post('/admin/diseases/deleteAll')
